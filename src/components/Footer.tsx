				...
				<Row>
					<Col md={4}>
						<p className='text-justify'>
							<span className='logo-font'>tuantanah</span> adalah lorem ipsum
							dolor sit amet consectetur adipisicing elit. Mollitia cupiditate
							iste voluptatum voluptas dolores quod mollitia obcaecati.
						</p>
						...
						<div className='d-flex justify-content-start'>
							<div className='mr-1'>
								<a
									...
									href='https://instagram.com/kaliwa__'
								>
				...
				<Row>
					<Col>
						<div className='d-flex justify-content-center'>
							<img src={gambar} alt='gambar' height='25' />
						</div>
						<div className='mt-2 d-flex justify-content-center align-items-center'>
							<p className='font-weight-light font-small'>
								Copyright © <span className='logo-font'>tuantanah</span>{' '}
								{new Date().getFullYear()}. All rights reserved
							</p>
						</div>
						<div className='d-flex justify-content-center font-small'>
							Build with <IoIosHeart size='1.5em' />{' '}
							{/* <DiReact size="1.7em" className="react-logo" /> */}
